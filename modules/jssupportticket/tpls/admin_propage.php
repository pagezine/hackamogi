    ...
    <span class="js-adminhead-title"> <a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket');?>"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a> <span class="jsheadtext"><?php echo __("Pro Features", 'js-support-ticket') ?></span>
        ...
        <div class="js-row js-pro-feature-wrapper">
            <div class="js-col-md-6 js-col-xs-12 js-pro-feature">
                        ...
                        <span class="js-pro-feature-description"><?php echo __('Unlimited color tools to desire result','js-support-ticket'); ?></span>
                    </div>
                    <div class="js-col-md-6 js-col-xs-12 js-pro-feature">
                        ...
                        <span class="js-pro-feature-description"><?php echo __("Internal mail system for communication withing staffs and administrator",'js-support-ticket'); ?></span>
                    </div>
                    <div class="js-col-md-6 js-col-xs-12 js-pro-feature">
                        ...
                        <span class="js-pro-feature-description"><?php echo __('Access control limit you can limit your staff to do specific task','js-support-ticket'); ?></span>
                    </div>
                    <div class="js-col-md-6 js-col-xs-12 js-pro-feature">
                        ...
                        <span class="js-pro-feature-description"><?php echo __('Staff member create premade message premade available in ticket reply','js-support-ticket'); ?></span>
                    </div>
                    <div class="js-col-md-6 js-col-xs-12 js-pro-feature">
                        ...
                        <span class="js-pro-feature-description"><?php echo __('Staff member can be created and reply your customer tickets','js-support-ticket'); ?></span>
                    </div>
                    <div class="js-col-md-6 js-col-xs-12 js-pro-feature">
                    ...
                    <div class="js-col-md-6 js-col-xs-12 js-pro-feature">
                        ...
                        <span class="js-pro-feature-description"><?php echo __("You can Manager FAQs",'js-support-ticket'); ?></span>
                    </div>
                    <div class="js-col-md-6 js-col-xs-12 js-pro-feature">
                        ...
                        <span class="js-pro-feature-description"><?php echo __('You can ban and unabn any spam email address','js-support-ticket'); ?></span>
                    </div>
                    <div class="js-col-md-6 js-col-xs-12 js-pro-feature">
                        ...
                        <span class="js-pro-feature-description"><?php echo __('If and only if customer not reply certain days ticket marked overdue','js-support-ticket'); ?></span>
                    </div>
                    <div class="js-col-md-6 js-col-xs-12 js-pro-feature">
                    ...
                    <div class="js-col-md-6 js-col-xs-12 js-pro-feature">
                        ...
                        <span class="js-pro-feature-description"><?php echo __('Visitor can also open ticket in you support system','js-support-ticket'); ?></span>
                    </div>
                    <div class="js-col-md-6 js-col-xs-12 js-pro-feature">
                        ...
                        <span class="js-pro-feature-description"><?php echo __('You can now lock or unlock any ticket for certain time','js-support-ticket'); ?></span>
                    </div>
                    <div class="js-col-md-6 js-col-xs-12 js-pro-feature">
                        ...
                        <span class="js-pro-feature-description"><?php echo __('Internal notes for staff members and administrator ticket based','js-support-ticket'); ?></span>
                    </div>
                    <div class="js-col-md-6 js-col-xs-12 js-pro-feature">
                    ...
                    <div class="js-col-md-6 js-col-xs-12 js-pro-feature">
                        ...
                        <span class="js-pro-feature-description"><?php echo __('Staff member can provide time and description for time while working on a ticket','js-support-ticket'); ?></span>
                    </div>
        </div>
    </div>
</div>
